...
## [Unreleased] - 2026-09-12 (cancellable compiles, conic gradient parity)

Three fixes from the glyph-halo diagnosis (`project-docs/glyph-halo-diagnosis/`, `project-docs/known-issues.md` ISSUE-016 / ISSUE-017). Verified end to end by `scripts/debug-compile-cancel-and-conic.ts` (23 browser checks) plus `project-docs/conic-parity/` renders of one fixture through the CLI wedges, the WebGPU shader and the Canvas 2D fallback.
