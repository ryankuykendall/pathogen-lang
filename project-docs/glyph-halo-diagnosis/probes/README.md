...
| `angle-convention-and-winding.pathogen` | `tangent(t).angle` and `normal(t).angle` both ∈ (−π, π] since ISSUE-020 (the normal was (−1.5π, 0.5π] before 2026-09-12), dead `switch` ranges above π, outward vs inward normals per contour winding |
