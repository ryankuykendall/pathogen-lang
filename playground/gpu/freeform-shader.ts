...
export const FREEFORM_PARAMS_SIZE: number = 32;

// Each ColorPoint is 6 x f32 = 24 bytes
export const COLOR_POINT_STRIDE: number = 24;

export const FREEFORM_VERTEX_WGSL: string = /* wgsl */ `
struct VertexOutput {
...
export const FREEFORM_FRAGMENT_WGSL: string = /* wgsl */ `
