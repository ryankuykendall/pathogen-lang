...
export const TOPO_PARAMS_SIZE = 32;

// Each ContourHeader is 4 x u32/f32 = 16 bytes
export const CONTOUR_HEADER_STRIDE = 16;
...
export const TOPO_COLOR_STOP_STRIDE = 16;

export const TOPO_VERTEX_WGSL = /* wgsl */ `
struct VertexOutput {
 ...
 * @returns {string}
 */
export function getTopoShaderCode() {
  return TOPO_FRAGMENT_WGSL;
}

export const TOPO_FRAGMENT_WGSL = /* wgsl */ `
