...
export const LAPLACE_INIT_PARAMS_SIZE = 16;

// Uniform buffer size for JacobiParams
// Byte layout: width u32 (4), height u32 (4) = 8 bytes
export const LAPLACE_JACOBI_PARAMS_SIZE = 8;
...
export const LAPLACE_RENDER_PARAMS_SIZE = 32;
...
export const TOPO_LAPLACE_INIT_WGSL = /* wgsl */ `
struct InitParams {
  width: f32,
  height: f32,
  contour_count: u32,
...
export const TOPO_LAPLACE_JACOBI_WGSL = /* wgsl */ `
struct JacobiParams {
  width: u32,
  height: u32,
};
...
export const TOPO_LAPLACE_RENDER_WGSL = /* wgsl */ `
