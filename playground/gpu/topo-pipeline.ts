...
export interface TopoPipelineResult {
  device: GPUDevice;
  pipeline: GPURenderPipeline;
  format: GPUTextureFormat;
}

let cachedTopoPipeline: GPURenderPipeline | null = null;
let topoPipelineDevice: GPUDevice | null = null;
let cachedTopoFormat: GPUTextureFormat | null = null;
 ...
 */
export async function getTopoPipeline(): Promise<TopoPipelineResult | null> {
  ...
  try {
    ...
    console.warn('[WebGPU] Failed to create topo pipeline:', (e as Error).message);
