...
export type { AnnotatedOutput, AnnotatedLine, EvaluateWithContextResult, EvaluateWithContextOptions, PathContext, Point, CommandHistoryEntry, LogEntry, LogPart, LayerOutput, CompileResult, LayerStyle, StyleBlockValue, ArrayValue, ObjectValue, PointValue, TextElement, TextChild, PathLayerState, TextLayerState, FragmentLayerState, SVGFragmentValue, PathBlockValue, ProjectedPathValue, PathBlockCommand, MaskValue, ClipPathValue, MaskOutput, ClipPathOutput, MaskPathEntry, GradientValue, GradientOutput, GradientStop, ColorValue, CSSVarValue, CSSPropertyDeclaration } from './evaluator';
